# План реализации системы сайтов Direct-line

## Часть 1 — Архитектура и маршруты

### 1.1. Обзор системы

Система сайтов Direct-line строится как **продуктовая платформа** с единой архитектурой, состоящая из:
...
- [ ] Наполнение контентом из документации Direct-line
...
- [ ] Страница /security (контент из analysis_kero_directline.md)
...
| **FAQ для услуг** | Шаблон + вопросы | analysis_kero_directline.md |
...
2. **Цветовая палитра:** Есть ли предпочтения по цветам?
   ...
   - Корпоративные цвета Direct-line (если есть брендбук)
