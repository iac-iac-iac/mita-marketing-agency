          ...
          items={[
            {
              ...
              role: 'CEO',
              company: 'TechStart',
              quote: 'Благодаря М.И.Т.А. мы получили стабильный поток качественных лидов. За 3 месяца конверсия выросла на 45%.',
            },
            {
              name: 'Мария Козлова',
              role: 'CMO',
              company: 'RetailPro',
              quote: 'Профессиональный подход к аналитике и оптимизации. ROI от рекламных кампаний увеличился в 2.5 раза.',
            },
            {
              name: 'Дмитрий Волков',
              role: 'Founder',
              company: 'AutoPremium',
              quote: 'Комплексная работа с воронкой продаж дала результат: +147% новых клиентов за первый квартал.',
            },
          ]}
        />
